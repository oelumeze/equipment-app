Blue Line Code Sample

To spin up this project, ensure you have started the equipments API

- After unzipping the project, ensure you have create-react-app by running `npm install create-react-app --save`
- Then, run `npm install --save` to ensure all module/depenedencies are up to date
